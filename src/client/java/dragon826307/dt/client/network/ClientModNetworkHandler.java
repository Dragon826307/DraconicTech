...
public class ClientModNetworkHandler {
    public static void init() {
        ClientPlayNetworking.registerGlobalReceiver(Mod$CheckingModS2CPacket.ID, (mod$CheckingModS2CPacket, context) -> context.responseSender().sendPacket(new Mod$HelloDraconicTechC2SPacket()));
